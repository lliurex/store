...
class details(QStackedWindowItem):
	...
	def __initScreen__(self):
		...
		layInfo.addWidget(self.lblTags,0,0,1,1,Qt.AlignTop|Qt.Alignment(-1))
		...
		layInfo.addWidget(self.lblHomepage,1,0,1,1,Qt.AlignBottom)
	...
	def updateScreen(self):
		...
		self.lblIcon.loadImg(self.app)
		self.lblSummary.setText("<h2>{}</h2>".format(self.app.get('summary','').strip()))
